...
# Galarians should have catch_rate equivalent to their base variants; data transformation needed
...
# Galarians should have percentage_male equivalent to their base variants; data transformation needed
# Others are genderless; appropriate nulls

## Transformation
# base_friendship and base_experience have bad nulls, drop columns
df.drop(columns=['base_friendship', 'base_experience'], inplace=True)

# Galarians should have catch_rate and percentage_male equivalent to their base variants
# this is handled in the streamlit code
